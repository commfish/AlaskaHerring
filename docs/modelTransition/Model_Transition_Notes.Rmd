...
$M\_Bk$: number of mortality blocks (1 split = 2 blocks)
$M\_Bk\_Yrs$: specific years in which mortality M changes
...
$M$: natural mortality
$Sur$: survival matrix *FLAG* is this here for age-dependent survival?
$S$: survival vector
$S\_for$: mean survival (for forecasting)
  
Maturity
$mat\_a$: age at 50% maturity
$mat\_b$: maturity-at-age slope
$Mat$: Maturity-at-age matrix (1,myrs,1,nages)
$mat\_fore$: *FLAG CHECK* forecast maturity-at-age
...
$int2$: *FLAG - what is pop rec* proportion of pop rec to gear * weight-at-age
$int3$: int2 summed over ages
...
$post\_naa$: total numbers-at-age (mature + immature) - catch (millions)     
$est\_egg\_naa$: egg production-at-age (trillions)     
