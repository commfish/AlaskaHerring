...
3.  Natural mortality - Steve had the estimation for natural mortality deviations turned off. Got them turned on, tested the cubic spline functionality, and changed the prior to be consistent with the BC stock assessment.
