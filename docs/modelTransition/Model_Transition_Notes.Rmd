...
1.    Population dynamcis equations and assumptions related to maturity and selectivity:
...
$Nij$: numbers-at-age 
$Oij$: mature numbers-at-age after fishery (spawning population) *FLAG - get rid of this with new variables*
...
$sp\_Bij$: of post-fishery mature (spawning) biomass-at-age by year $i$
$sp\_B$: of post-fishery mature (spawning) biomass by year $i$
